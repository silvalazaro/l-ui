...
import { getCurrentScope, onScopeDispose, watch, unref, ref as ref$1, defineComponent, openBlock, createElementBlock, createElementVNode, warn, getCurrentInstance, computed as computed$2, inject, onMounted, toRef, onUnmounted, onBeforeUnmount, onBeforeMount, provide, mergeProps, renderSlot, useAttrs as useAttrs$1, useSlots, shallowRef, nextTick, onUpdated, withDirectives, normalizeClass, normalizeStyle, createCommentVNode, Fragment, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, vShow, cloneVNode, Text, Comment, resolveComponent, Teleport, Transition, createTextVNode, readonly as readonly$1, reactive as reactive$1, isRef as isRef$1 } from "vue";
...
const useNamespace = (block) => {
  ...
  const namespace = computed$2(() => globalConfig2.value || defaultNamespace);
  ...
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function reorder(array4, indexes) {
        ...
        while (length--) {
          var index = indexes[length];
          array4[length] = isIndex(index, arrLength) ? oldArray[index] : undefined$1;
        }
        return array4;
      }
      ...
      function chunk(array4, size3, guard) {
        if (guard ? isIterateeCall(array4, size3, guard) : size3 === undefined$1) {
          size3 = 1;
        } else {
        ...
        while (index < length) {
          result2[resIndex++] = baseSlice(array4, index, index += size3);
        }
        return result2;
      }
...
var __unplugin_components_2 = { name: "ep-question-filled", render: render$1 };
var elButton = "";
const _hoisted_1$1 = {
  preserveAspectRatio: "xMidYMid meet",
  viewBox: "0 0 1024 1024",
...
var __unplugin_components_0 = { name: "ep-check", render };
const _hoisted_1 = {
  key: 0,
